...
import { CreateDocumentData, Document } from "@/hooks";
import Category from "./category/category";
import Speciality from "./speciality/speciality";
import { Textarea } from "@/components/ui/textarea";

export interface CreateUpdateFormSubmitArgs {
  formData: CreateDocumentData;
  template?: Document | null;
  event: React.FormEvent;
}

interface CreateUpdateDocumentProps extends DialogProps {
  onSuccess?: () => void;
  template?: Document | null;
  isPending?: boolean;
  onCancel?: () => void;
...
const formDetails = {
  create: {
    ...
    description: "Create a new document for your chat conversations",
    actionTitle: "Create Document",
  },
  update: {
    title: "Edit Document",
    description: "Make changes to your document below.",
    actionTitle: "Save Changes",
  },
};

const CreateUpdateDocumentDialog: React.FC<CreateUpdateDocumentProps> = ({
  onSuccess,
  template,
  onCancel,
  isPending,
...
export default CreateUpdateDocumentDialog;
